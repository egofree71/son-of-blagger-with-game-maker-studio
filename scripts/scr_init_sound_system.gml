...
global.snd_key = sga_CreateFX( "Key.ogg", 0 );
global.snd_dying = sga_CreateFX( "Dying.ogg", 0 );
global.snd_display_level = sga_CreateFX( "Display_level.ogg", 0 );
global.snd_start_level = sga_CreateFX( "Start_level.ogg", 0 );